...
import { educationSchemaType, translatoinDataSchema, workExperienceSchemaType, awardProjectCompetitionSchemaType, awardProjectSchemaType, awardsSchemaType, educationSchoolSchemaType, workExperienceCompanySchemaType, profileSchemaType, aboutSchemaType, skillsSchemaType, projectSchemaType, projectProjectsSchemaType, translatoinDataSchemaType } from "@/types/page";
import { number } from 'zod';



const renderProfile = ({ profileData }: { profileData: profileSchemaType }) => {
  return (
    <>
      {/* <!-- Profile --> */}
      <div id="profile" className="flex items-center gap-x-3">
        <div className="shrink-0">
          <img className="shrink-0 size-16 rounded-full" src="/profile.jpg" alt="Avatar" />
        </div>
...
const renderAbout = ({ aboutData }: { aboutData: aboutSchemaType }) => {
  return (
    <>
      {/* <!-- About --> */}
      <div id="about" className="mt-8">
        {
          aboutData.autobiography.map((content: string, idx: number) => (
            <p key={idx} className="indent-8 text-sm text-gray-600 dark:text-neutral-400">
              {content}
            </p>
          ))
        }
        ...
        <ul className="mt-5 flex flex-row gap-x-3">
          <li className="flex items-center gap-x-2.5">
            <a className="text-[13px] text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2 dark:text-neutral-500 dark:hover:text-neutral-400" href="mailto:simonchu199510@gmail.com">
          ...
          <li className="flex items-center gap-x-2.5">
            <a className="text-[13px] text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2 dark:text-neutral-500 dark:hover:text-neutral-400" href="https://github.com/xchux">
          ...
          <li className="flex items-center gap-x-2.5">
            <a className="text-[13px] text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2 dark:text-neutral-500 dark:hover:text-neutral-400" href="https://www.linkedin.com/in/simon-chu-tw/">
              <svg className="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li className="flex items-center gap-x-2.5">
            <a className="text-[13px] text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2 dark:text-neutral-500 dark:hover:text-neutral-400" href="https://medium.com/@chu-chu">
              <svg className="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const renderWorkExperience = ({ workExpData }: { workExpData: workExperienceSchemaType }) => {
  return (
    <>
      {/* <!-- Work Experience --> */}
      <div id="work-experience" className="mt-10 sm:mt-14">
        <h2 className="mb-5 font-bold text-xl text-gray-800 dark:text-neutral-200">
          {workExpData.title}
        </h2>
        ...
        <div>
          {
            workExpData.companies.map((company: workExperienceCompanySchemaType, idx: number) => (
              <div key={idx} className="group relative flex gap-x-5">
                ...
                <div className="grow pb-8 group-last:pb-0">
                  ...
                  <ul className="list-disc ms-6 mt-3 space-y-1.5">
                    {
                      company.descriptions.map((desc: string, index: number) => (
...
const renderProjects = ({ projectData }: { projectData: projectSchemaType }) => {
  return (
    <>

      {/* <!-- Project --> */}
      <div id="project" className="my-10 sm:my-14">
        <h2 className="mb-5 font-bold text-xl text-gray-800 dark:text-neutral-200">
          {projectData.title}
        </h2>
        ...
        <ul className="space-y-10">
          {
            projectData.projects.map((project: projectProjectsSchemaType, idx: number) => (
              <li key={idx}>
                ...
                <ul className="list-disc ms-6 mt-3 space-y-1.5">
                  {
                    project.descriptions.map((desc: string, index: number) => (
                      <li key={index} className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                        {desc}
                      </li>
                    ))
...
const renderEducation = ({ educationData }: { educationData: educationSchemaType }) => {
  return (
    <>
      {/* <!-- Education --> */}
      <div id="education" className="mt-10 sm:mt-14">
        <h2 className="mb-3 font-bold text-xl text-gray-800 dark:text-neutral-200">
          {educationData.title}
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {
            educationData.schools.map((school: educationSchoolSchemaType, idx: number) => (
              <div key={idx} className="p-4 border border-gray-200 rounded-lg dark:border-neutral-700">
                <Image src={`/${school.icon}.svg`} alt="" width={20} height={20} />
...
const renderSkills = ({ skillData }: { skillData: skillsSchemaType }) => {
  return (
    <>
      {/* <!-- Skills --> */}
        ...
        <div className="space-y-3">
          <dl className="flex flex-col sm:flex-row gap-1">
            <dt className="min-w-40">
              <span className="block text-sm text-gray-500 dark:text-neutral-500">{skillData.frontend.title}</span>
            </dt>
            <dd>
              <ul>
          ...
          <dl className="flex flex-col sm:flex-row gap-1">
            <dt className="min-w-40">
              <span className="block text-sm text-gray-500 dark:text-neutral-500">{skillData.devOps.title}</span>
            </dt>
            <dd>
              <ul>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                  <svg className="shrink-0 size-4 me-1" width="24" height="24" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                    <rect width="48" height="48" fill="none"></rect> <rect width="48" height="48" fill="none"></rect>
                    <rect x="10" y="19.3" width="4.4" height="4.44"></rect> <rect x="4.6" y="19.3" width="4.4" height="4.44"></rect>
                    <path d="M45.4,21.7a6.3,6.3,0,0,0-5.2-.6,6.6,6.6,0,0,0-2.9-4.4l-.5-.5-.5.6A6.1,6.1,0,0,0,35.2,21a5.6,5.6,0,0,0,1,2.8l-1.5.7a10.5,10.5,0,0,1-3,.5H2.2v.6a12.1,12.1,0,0,0,1,6.5l.4.8h0c2.8,4.6,7.7,6.6,13,6.6,10.3,0,18.7-4.4,22.7-14,2.6.2,5.2-.5,6.5-3L46,22ZM10.8,33.5a2.3,2.3,0,1,1,0-4.6,2.3,2.3,0,1,1,0,4.6Z"></path>
                    <rect x="10" y="13.7" width="4.4" height="4.44"></rect>
                    <rect x="26.5" y="19.3" width="4.4" height="4.44"></rect>
                    <rect x="21.1" y="8" width="4.4" height="4.44"></rect> <rect x="21.1" y="19.3" width="4.4" height="4.44"></rect>
                    <rect x="15.6" y="13.7" width="4.4" height="4.44"></rect> <rect x="21.1" y="13.7" width="4.4" height="4.44"></rect>
                    <rect x="15.6" y="19.3" width="4.4" height="4.44"></rect>
                  </svg>
                  Docker
                </li>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                  <svg className="shrink-0 size-4 me-1" width="24" height="24" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
                   <g fill="#000000"> 
...
const renderAward = ({ item }: { item: awardsSchemaType }) => {
  return (
    <div id="award" className="space-y-4">
      <h2 className="font-bold text-xl text-gray-800 dark:text-neutral-200">
        {item.title}
      </h2>
        ...
        <div key={idx} className="bg-sky-100 p-6 rounded-lg shadow-sm">
          ...
          <ul className="mt-3 space-y-1">
            {project.competitions.map((competition: awardProjectCompetitionSchemaType, index: number) => (
              <li key={index} className="list li-item  items-center text-gray-800 dark:text-neutral-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline-flex">
                  <path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526" fill="#FFFF00"></path>
                  <circle cx="12" cy="8" r="6" fill="#FFFF00"></circle>
                </svg>
...
export default function Page(data: translatoinDataSchemaType) {
  return (
    <>
      <main id="content">
        <div className="w-full max-w-2xl mx-auto pt-10 md:pt-16 px-4 sm:px-6 lg:px-8">
          {renderProfile({ profileData: data.profile })}
          {renderAbout({ aboutData: data.about })}
          {renderWorkExperience({ workExpData: data.workExperience })}
          {renderEducation({ educationData: data.education })}
          {renderProjects({ projectData: data.project })}
          {renderSkills({ skillData: data.skills })}
          {renderAward({ item: data.awards })}
        </div>
      </main>
    </>
  );
